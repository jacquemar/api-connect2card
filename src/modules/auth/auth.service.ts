...
export class AuthService {
  ...
  async forgotPassword(forgotPasswordDto: ForgotPasswordDto, req: any): Promise<{ message: string }> {
    ...
    try {
      ...
      return { message: `Un e-mail de réinitialisation a été envoyé à ${user.email}` };
    } catch (error) {
